        ...
        <table className="min-w-full border rounded">
          <thead className="bg-gray-100">
            <tr>
              ...
              <th className="py-2 px-4 border">Order Status</th>
              <th className="py-2 px-4 border">Actions</th>
              <th className="py-2 px-4 border">View Documents</th> {/* New column */}
            </tr>
          </thead>
          <tbody>
            {assignedOrders.length === 0 && !loadingOrders && (
        ...
        return (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div className="bg-white p-6 rounded shadow-lg w-1/3">
              ...
              {hasDeliverables ? (
                <div className="mb-4">
                  <h3 className="font-semibold mb-2 text-green-600">Existing Deliverables:</h3>
                  <ul className="list-disc pl-5">
                    {orderDeliverables.map((d) => (
                      <li key={d.id} className="mb-1">
                        Version {d.versions} -{" "}
      ...
      {viewDocumentsOrder && (
        <div className="fixed inset-0 backgrop-blur-sm bg-opacity-50 flex items-center justify-center">
          <div className="bg-white p-6 rounded shadow-lg w-1/3">
            ...
            {viewDocumentsOrder.order_documents && viewDocumentsOrder.order_documents.length > 0 ? (
              <ul className="list-disc pl-5">
